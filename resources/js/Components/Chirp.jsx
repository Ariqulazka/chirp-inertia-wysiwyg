...
import 'react-quill/dist/quill.snow.css'; // Tambahkan CSS ReactQuill
import DOMPurify from 'dompurify'; // Tambahkan DOMPurify untuk sanitasi HTML
...
export default function Chirp({ chirp }) {
    ...
    const { data, setData, patch, clearErrors, reset, errors } = useForm({
        message: chirp.message, // Tetap gunakan "message" untuk menyimpan konten
    });
            ...
            <div className="flex-1">
                ...
                {editing
                    ? <form onSubmit={submit}>
                        {/* Gunakan ReactQuill untuk pengeditan */}
                        <ReactQuill
                            value={data.message}
                            onChange={(content) => setData('message', content)}
                            className="mt-4 bg-white rounded-md shadow-sm"
                        />
                    ...
                    : (
                        // Sanitasi dan render konten menggunakan DOMPurify
                        <div
